...
public class Tetris3DGame : Game<Tetris3DGame>
{
    ...
    public Tetris3DGame() : base("Tetris", WidthInSquares * SquareSide, HeightInSquares * SquareSide, Color.Black, true)
    {
        ...
        Vector3 cameraPosition = Camera3DDefaultPosition;
        Vector3 cameraTarget = Vector3.Zero;
        // ReSharper restore PossibleLossOfFraction

        var camera = new Camera3D(cameraPosition, cameraTarget, Vector3.UnitZ, 75.2f, CameraProjection.Perspective)
        {
            Up = Vector3.UnitY
        };
        var cameraGameObject = new Camera(camera);
    ...
    public Vector3 Camera3DDefaultPosition { get; } = new(0, 0, -800);
    #endregion
